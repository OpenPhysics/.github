...
if ! grep -q "OpenPhysics/.github/.github/workflows/shared-dependency-review.yml@main" .github/workflows/ci.yml; then
  fail "ci.yml must call shared dependency-review workflow"
elif ! grep -q "OpenPhysics/.github/.github/workflows/shared-codeql.yml@main" .github/workflows/ci.yml; then
